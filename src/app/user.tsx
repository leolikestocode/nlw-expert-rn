...
export default function User() {
  ...
  function handleSaveProfile() {
    if (
      ...
      return Alert.alert(
        "Erro",
        "Preencha todos os dados para salvar seu perfil"
      )
    }
  ...
  return (
    <View className="flex-1 pt-8">
      <Header
        title="Seu perfil"
        cartQuantityItems={cartStore.products.length}
      />

      <KeyboardAwareScrollView>
        <ScrollView>
          <Text className="text-white text-sm font-body my-8 text-center">
            {" "}
          ...
          <View className="mt-10 px-5 gap-4">
            ...
            <Input
              ...
              value={address}
              autoFocus={address.trim().length === 0}
