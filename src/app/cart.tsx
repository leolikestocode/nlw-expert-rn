  ...
  return (
    <View className="flex-1 pt-8">
      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          <Text className="text-slate-400 text-base font-body my-8 text-center">
            {" "}
      ...
      <View>
        <TouchableOpacity
          ...
          className=" py-5"
        >
          <Text className="text-base text-white text-center font-body">
            {products.length === 0
              ? "Voltar para o cardápio"
              : "Continuar comprando"}
          </Text>
        </TouchableOpacity>
          ...
          <>
            ...
            user.address.trim().length > 0 ? (
              <Button onPress={handleOrder}>
                ...
                <Button.Text>Ir para o pagamento</Button.Text>
              </Button>
            ) : (
